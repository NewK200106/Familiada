...
public class ClientApp extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Podaj dane aby grać");
	...
	public Scene makeInitScene(Stage primaryStage) {
		...
		Label hostNameLabel = new Label("Adres Serwera");
		Label portNumberLabel = new Label("Numer portu");
		Label errorLabel = new Label();
		/* Make the button and its handler */
		Button submitClientInfoButton = new Button("Potwierdź");
	...
	public Scene makeChatUI(Client client) {
        ...
        chatListView.setMinSize(1180,620);
		rootPane.add(chatTextField, 0, 1);


		/* Make and return the scene */
		return new Scene(rootPane, 1280, 720);
